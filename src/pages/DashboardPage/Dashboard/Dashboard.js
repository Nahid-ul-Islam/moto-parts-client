        ...
        <div class="drawer drawer-mobile">
            ...
            <div class="drawer-side">
                ...
                <ul class="menu p-4 overflow-y-auto w-80 bg-base-100 text-base-content font-bold text-lg">
                    ...
                    <li className='mb-2'><Link to='/dashboard/my-profile'>My Profile</Link></li>
                    {
                        !admin &&
                        <>
                            <li className='mb-2'><Link to='/dashboard/my-orders'>My Orders</Link></li>
                            <li className='mb-2'><Link to='/dashboard/add-review'>Add a Review</Link></li>
                        </>
                    }
...

                    {
                        admin &&
                        <>
                            <li className='mb-2'><Link to='/dashboard/manage-order'>Manage Order</Link></li>
                            <li className='mb-2'><Link to='/dashboard/manage-product'>Manage Product</Link></li>
                            <li className='mb-2'><Link to='/dashboard/add-product'>Add Product</Link></li>
                            <li className='mb-2'><Link to='/dashboard/users'>All User</Link></li>
                        </>
                    }
                </ul>
