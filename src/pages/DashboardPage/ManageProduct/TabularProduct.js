...
const TabularProduct = ({item, setFlag}) => {
    const { _id, name, price, availableQuantity } = item;
    const [id, setId] = useState(_id);
    const page = 'tabularProductPage';
    return (
        <div>
            <div>
                <ModalDelete
                ...
                <div className="">
                    <div className='w-full md:w-3/4 2xl:w-1/2 mx-auto'>
                        <div className='flex bg-white'>
                            ...
                            <div className='w-1/4 flex items-center justify-center border-[1px] md:border-2 border-gray-100'>
                                <p className='text-center text-sm text-gray-700'>{availableQuantity} </p>
                            </div>
                            <div className='w-1/4 flex items-center justify-center border-[1px] md:border-2 border-gray-100'>
